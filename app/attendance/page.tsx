...
export default function AttendancePage() {
  ...
  return <main className="min-h-screen bg-muted/30 p-4 text-foreground md:p-8">
    <div className="mx-auto max-w-6xl space-y-6">
      <header><p className="text-sm font-medium text-primary">Workforce operations</p><h1 className="text-3xl font-bold tracking-tight">Register</h1><p className="mt-1 text-muted-foreground">Record your shift attendance and keep the monthly performance score accurate.</p></header>
