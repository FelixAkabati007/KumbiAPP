...
import { ThermalPrinterTest } from "@/components/thermal-printer-test";
          ...
          <div className="flex items-center gap-4 mb-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-gray-600 dark:text-gray-400">
                Test and configure your thermal printer hardware
              </p>
            </div>
            <Link href="/settings">
              <Button
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500 dark:text-gray-400">
                      Check paper feed and print head status
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="space-y-3">
                  <h4 className="font-semibold text-gray-800 dark:text-gray-200">
                    Step 1: Enable Printer
                  </h4>
                  <ol className="text-sm text-gray-600 dark:text-gray-400 space-y-2">
                    <li>1. Go to Settings → System</li>
                    <li>2. Enable &quot;Thermal Printer&quot;</li>
                ...
                <div className="space-y-3">
                  ...
                  <ol className="text-sm text-gray-600 dark:text-gray-400 space-y-2">
                    ...
                    <li>3. Verify printer is detected</li>
                ...
                <div className="space-y-3">
                  ...
                  <ol className="text-sm text-gray-600 dark:text-gray-400 space-y-2">
                    <li>1. Use &quot;Test Print Text&quot; for basic test</li>
                    <li>
                      2. Try &quot;Test Receipt&quot; for formatted output
                    </li>
                    <li>3. Check paper output quality</li>
                    <li>4. Verify print settings</li>
                  </ol>
                </div>
              </div>
            </CardContent>
