...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      "fixed inset-x-3 bottom-3 z-[100] flex max-h-[calc(100dvh-1.5rem)] w-auto flex-col-reverse gap-2 p-0 sm:bottom-auto sm:left-auto sm:right-4 sm:top-4 sm:max-h-[calc(100dvh-2rem)] sm:w-[min(20rem,calc(100vw-2rem))] sm:flex-col",
      className,
    )}
    {...props}
  />
