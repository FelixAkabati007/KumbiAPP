...
export function StaffManagementPanel({ currentRole }: { currentRole: string }) {
              ...
              <div className="min-h-0 flex-1 overflow-y-auto pr-1">
                ...
                <div className="space-y-1.5">
                  ...
                  <Select
                    ...
                    onValueChange={(value) => {
                      const option = staffClassificationOptions.find((item) => item.value === value);
                      setCreateForm((f) => ({
                        ...f,
                  ...
                  >
                    ...
                    <SelectContent>
                      {staffClassificationOptions.map((option) => (
  ...
  <div className="text-xs text-muted-foreground">{staffClassificationOptions.find((option) => option.value === member.job_classification)?.label || member.job_classification || member.position || "Other"}</div>
                    </TableCell>
                    <TableCell>
                      <Badge
                        variant={
            ...
            <DialogContent className="flex max-h-[calc(100dvh-1rem)] w-[calc(100vw-1rem)] max-w-2xl flex-col overflow-hidden p-3 sm:max-h-[90dvh] sm:w-[calc(100vw-2rem)] sm:p-6">
                            ...
                            <div className="min-h-0 flex-1 overflow-y-auto overscroll-contain pr-2 [scrollbar-color:theme(colors.orange.400)_transparent] [scrollbar-width:thin]">
                              <div className="grid gap-4 py-2">
                              <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                                <div className="space-y-1.5">
