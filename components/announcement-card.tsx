...
export function AnnouncementCard({ embedded = false }: { embedded?: boolean }) {
  ...
  return (
    <Card className={embedded ? "border-0 bg-transparent shadow-none" : "hover:shadow-xl transition-all duration-300 bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm border border-orange-200 dark:border-orange-700 rounded-3xl md:hover:scale-105 relative overflow-hidden"}>{!embedded && <div className="absolute inset-0 bg-gradient-to-br from-orange-100/20 via-amber-100/20 to-yellow-100/20 dark:from-orange-900/20 dark:via-amber-900/20 dark:to-yellow-900/20" />}
      <CardHeader className={embedded ? "flex flex-col gap-3 border-b border-orange-100 px-0 pb-4 dark:border-orange-800 sm:flex-row sm:items-center sm:justify-between" : "relative z-10 flex flex-row items-start justify-between gap-3 rounded-t-3xl bg-gradient-to-r from-orange-500/10 via-amber-500/10 to-yellow-500/10 pb-3 dark:from-orange-400/10 dark:via-amber-400/10 dark:to-yellow-400/10"}>
