...
export function AnnouncementCard() {
  ...
  return (
    <Card className="border-orange-200 bg-card/90 shadow-sm dark:border-orange-800">
      ...
      {publishResult && <p role="status" className="mb-3 rounded-lg border border-primary/30 bg-primary/5 p-3 text-sm text-primary">{publishResult}</p>}<CardContent className="flex flex-col gap-3 pt-0">
