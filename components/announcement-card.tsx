...
const managerRoles: UserRole[] = ["admin", "manager", "restaurantManager", "hotelManager", "finance", "operationsManager"];
...
export function AnnouncementCard() {
  ...
  const canPublish = !!user && managerRoles.includes(user.role as UserRole);
  ...
  async function publish() {
    ...
    setTitle(""); setMessage(""); setOpen(false); await mutate();
  }

  return (
    <Card className="border-orange-200 bg-card/90 shadow-sm dark:border-orange-800">
